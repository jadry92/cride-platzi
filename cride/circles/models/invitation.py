...
class Invitation(CRideModel):
    ...
    A circle invitation is a random text that acts a as unique
    code to grant access to a specific circle.
    This unique codes are generated by users that are already
